...
all: pas_entropy_1_signalCol.bed pas_entropy_2_signalCol.bed

pas_entropy_1_signalCol.bed pas_entropy_2_signalCol.bed: all_pas_ent_non0.bed references/PAsignal_covered_reg_sort.bed references/AT_10_strict_positions_w1_sort.bed references/repeat_tablehg19_sort.bed references/genes_v34l37_w1000_noOverlap.bed
	./filter_pas.sh $@;
